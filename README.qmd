...
We will run the code on a computer with Ubuntu 22.04 after running the setup outlined in the link above.
...
You can also setup the files in the input folder as follows:
